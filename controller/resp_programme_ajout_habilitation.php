...
if(!isset($_POST['id'])){
	...
	include_once 'view/resp_programme_ajout_habilitation.php';
	...
	EC::habilite($_POST['id'], $_SESSION['id_programme']);
	
	header('Location: index.php?page=resp_programme_ajout_habilitation');
}
